...
void main() {
    ...
    // Deep Forest Archive #23372B to Obsidian Ink #171A1C
    vec3 color1 = vec3(0.137, 0.216, 0.169); // #23372B
    vec3 color2 = vec3(0.09, 0.102, 0.11);   // #171A1C
    
    float noise = sin(uv.x * 2.0 + u_time * 0.2) * cos(uv.y * 2.0 - u_time * 0.3);
    float dist = distance(uv, vec2(0.5, 0.5));
    
    vec3 finalColor = mix(color2, color1, clamp(1.0 - dist + noise * 0.2, 0.0, 1.0));
