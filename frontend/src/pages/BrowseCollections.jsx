...
<a className="font-label-md text-label-md text-on-primary dark:text-on-primary-container border-b-2 border-on-secondary-container hover:opacity-80 transition-opacity duration-300" href="#">Categories</a>
...
{/* Novels (Large) */}
<a className="category-card md:col-span-8 bg-surface-container-lowest rounded-xl overflow-hidden border border-outline-variant shadow-[0_4px_20px_rgba(23,26,28,0.05)] flex flex-col md:flex-row relative group animate-fade-in-up" href="#" style={{animationDelay: '0.1s'}}>
...
{/* Academic Books (Tall) */}
<a className="category-card md:col-span-4 bg-surface-container-lowest rounded-xl overflow-hidden border border-outline-variant shadow-[0_4px_20px_rgba(23,26,28,0.05)] flex flex-col relative group animate-fade-in-up" href="#" style={{animationDelay: '0.2s'}}>
...
{/* Islamic Books */}
<a className="category-card md:col-span-4 bg-surface-container-lowest rounded-xl overflow-hidden border border-outline-variant shadow-[0_4px_20px_rgba(23,26,28,0.05)] flex flex-col relative group animate-fade-in-up" href="#" style={{animationDelay: '0.3s'}}>
...
{/* Children Books */}
<a className="category-card md:col-span-4 bg-surface-container-lowest rounded-xl overflow-hidden border border-outline-variant shadow-[0_4px_20px_rgba(23,26,28,0.05)] flex flex-col relative group animate-fade-in-up" href="#" style={{animationDelay: '0.4s'}}>
...
<a className="category-card bg-surface-container-lowest rounded-xl p-lg border border-outline-variant shadow-[0_4px_20px_rgba(23,26,28,0.05)] flex-grow flex flex-col justify-center" href="#">
...
<a className="category-card bg-surface-container-lowest rounded-xl p-lg border border-outline-variant shadow-[0_4px_20px_rgba(23,26,28,0.05)] flex-grow flex flex-col justify-center relative overflow-hidden" href="#">
