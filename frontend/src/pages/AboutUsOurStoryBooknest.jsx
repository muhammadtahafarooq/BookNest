...
{/* Brand */}
<a className="font-display-lg text-display-lg font-bold text-on-primary font-fraunces flex items-center gap-2" href="#">
...
<a className="font-label-md text-label-md text-outline-variant hover:text-on-primary transition-colors hover:bg-primary-container/50 transition-all duration-400 py-2 px-3 rounded-md" href="#">Shop</a>
<a className="font-label-md text-label-md text-outline-variant hover:text-on-primary transition-colors hover:bg-primary-container/50 transition-all duration-400 py-2 px-3 rounded-md" href="#">Categories</a>
<a className="font-label-md text-label-md text-outline-variant hover:text-on-primary transition-colors hover:bg-primary-container/50 transition-all duration-400 py-2 px-3 rounded-md" href="#">Best Sellers</a>
<a className="font-label-md text-label-md text-outline-variant hover:text-on-primary transition-colors hover:bg-primary-container/50 transition-all duration-400 py-2 px-3 rounded-md" href="#">New Arrivals</a>
</nav>
{/* Trailing Actions */}
<div className="flex items-center gap-4">
<button className="text-on-primary hover:text-antique-brass transition-colors scale-95 duration-200 ease-in-out">
<span className="material-symbols-outlined text-2xl">favorite</span>
</button>
<button className="text-on-primary hover:text-antique-brass transition-colors scale-95 duration-200 ease-in-out relative">
...
<div>
<a className="font-headline-md text-headline-md font-bold text-on-primary font-fraunces flex items-center gap-2 mb-4" href="#">
...
<a className="font-body-sm text-body-sm text-secondary-fixed font-bold hover:text-on-primary transition-all opacity-80 hover:opacity-100 transition-opacity" href="#">About Us</a>
<a className="font-body-sm text-body-sm text-outline-variant hover:text-on-primary transition-all opacity-80 hover:opacity-100 transition-opacity" href="#">Contact</a>
</div>
{/* Links Column 2 */}
<div className="col-span-1 flex flex-col gap-3">
<span className="font-label-sm text-label-sm text-outline-variant uppercase tracking-widest mb-2">Legal</span>
<a className="font-body-sm text-body-sm text-outline-variant hover:text-on-primary transition-all opacity-80 hover:opacity-100 transition-opacity" href="#">Shipping Policy</a>
<a className="font-body-sm text-body-sm text-outline-variant hover:text-on-primary transition-all opacity-80 hover:opacity-100 transition-opacity" href="#">Terms of Service</a>
<a className="font-body-sm text-body-sm text-outline-variant hover:text-on-primary transition-all opacity-80 hover:opacity-100 transition-opacity" href="#">Privacy Policy</a>
</div>
</div>
</footer>
    </>
